          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Spring 24', link: '/FinalSolve/Spring24/sprng24F' },
              ]
            }
          ],
        }
      ...
      '/MyProjects/': [
        {
          text: 'My Project',
          items: [
            { text: 'Introduction', link: '/my-project/introduction' },
            { text: 'Features', link: '/my-project/features' },
            { text: 'Setup', link: '/my-project/setup' },
            { text: 'Usage', link: '/my-project/usage' },
          ]
        }
      ]
    }
